...
static const _JointMsg_type_support_symbol_names_t _JointMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usm_interface, msg, JointMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usm_interface, msg, JointMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usm_interface, msg, JointMsg)() {
  return &::usm_interface::msg::rosidl_typesupport_c::JointMsg_message_type_support_handle;
}
