...
#include "usm_interface/msg/detail/error_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ErrorMsg__ros_msg_type = usm_interface__msg__ErrorMsg;
  ...
  void * untyped_ros_message)
{
  ...
  _ErrorMsg__ros_msg_type * ros_message = static_cast<_ErrorMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_usm_interface__msg__ErrorMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ErrorMsg__ros_msg_type * ros_message = static_cast<const _ErrorMsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ErrorMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_usm_interface__msg__ErrorMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_usm_interface
size_t max_serialized_size_usm_interface__msg__ErrorMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_usm_interface__msg__ErrorMsg(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usm_interface, msg, ErrorMsg)() {
