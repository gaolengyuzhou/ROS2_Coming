...
#include "communication_interfaces/msg/detail/thruster_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ThrusterMsg__ros_msg_type = communication_interfaces__msg__ThrusterMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ThrusterMsg__ros_msg_type * ros_message = static_cast<const _ThrusterMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: controller_id
  {
    cdr << ros_message->controller_id;
  }

  // Field name: controller_set
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ThrusterMsg__ros_msg_type * ros_message = static_cast<_ThrusterMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: controller_id
  {
    cdr >> ros_message->controller_id;
  }
...
static uint32_t _ThrusterMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication_interfaces__msg__ThrusterMsg(
...
{
  return max_serialized_size_communication_interfaces__msg__ThrusterMsg(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ThrusterMsg = {
...
static rosidl_message_type_support_t _ThrusterMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ThrusterMsg,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication_interfaces, msg, ThrusterMsg)() {
  return &_ThrusterMsg__type_support;
}
