...
#include "communication_interfaces/msg/detail/cabin_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const communication_interfaces::msg::CabinMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  communication_interfaces::msg::CabinMsg & ros_message)
{
  // Member: cabin_id
  cdr >> ros_message.cabin_id;
...
{
  auto typed_message =
    static_cast<const communication_interfaces::msg::CabinMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_interfaces::msg::CabinMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CabinMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const communication_interfaces::msg::CabinMsg *>(
...
{
  return max_serialized_size_CabinMsg(full_bounded, 0);
}

static message_type_support_callbacks_t _CabinMsg__callbacks = {
...
static rosidl_message_type_support_t _CabinMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CabinMsg__callbacks,
...
{
  return &communication_interfaces::msg::typesupport_fastrtps_cpp::_CabinMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_interfaces, msg, CabinMsg)() {
  return &communication_interfaces::msg::typesupport_fastrtps_cpp::_CabinMsg__handle;
}
