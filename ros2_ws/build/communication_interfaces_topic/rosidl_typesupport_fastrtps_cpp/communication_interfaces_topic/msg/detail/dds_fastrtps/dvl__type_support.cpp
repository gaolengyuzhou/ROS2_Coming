...
#include "communication_interfaces_topic/msg/detail/dvl__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const communication_interfaces_topic::msg::DVL & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: dvl_data
  {
    cdr << ros_message.dvl_data;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  communication_interfaces_topic::msg::DVL & ros_message)
{
  // Member: dvl_data
  {
    cdr >> ros_message.dvl_data;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 9;
    size_t item_size = sizeof(ros_message.dvl_data[0]);
...
{
  auto typed_message =
    static_cast<const communication_interfaces_topic::msg::DVL *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_interfaces_topic::msg::DVL *>(
    untyped_ros_message);
...
{
  return &communication_interfaces_topic::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_interfaces_topic, msg, DVL)() {
  return &communication_interfaces_topic::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
