...
#include "communication_interfaces_topic/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const communication_interfaces_topic::msg::Pose & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose_data
  {
    cdr << ros_message.pose_data;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  communication_interfaces_topic::msg::Pose & ros_message)
{
  // Member: pose_data
  {
    cdr >> ros_message.pose_data;
  ...
  size_t current_alignment)
{
  ...
  // Member: pose_data
  {
    ...
    size_t item_size = sizeof(ros_message.pose_data[0]);
...
{
  auto typed_message =
    static_cast<const communication_interfaces_topic::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_interfaces_topic::msg::Pose *>(
    untyped_ros_message);
...
{
  return &communication_interfaces_topic::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_interfaces_topic, msg, Pose)() {
  return &communication_interfaces_topic::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
