...
#include "communication_interfaces_topic/msg/detail/dvl__rosidl_typesupport_fastrtps_c.h"
...
using _DVL__ros_msg_type = communication_interfaces_topic__msg__DVL;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 9;
    auto array_ptr = ros_message->dvl_data;
...
size_t get_serialized_size_communication_interfaces_topic__msg__DVL(
  const void * untyped_ros_message,
...
static uint32_t _DVL__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication_interfaces_topic__msg__DVL(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_interfaces_topic
size_t max_serialized_size_communication_interfaces_topic__msg__DVL(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_communication_interfaces_topic__msg__DVL(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication_interfaces_topic, msg, DVL)() {
