...
#include "communication_interfaces_topic/msg/detail/depth__rosidl_typesupport_fastrtps_c.h"
...
using _Depth__ros_msg_type = communication_interfaces_topic__msg__Depth;
  ...
  void * untyped_ros_message)
{
  ...
  _Depth__ros_msg_type * ros_message = static_cast<_Depth__ros_msg_type *>(untyped_ros_message);
  // Field name: depth_data
  {
    cdr >> ros_message->depth_data;
  }
...
size_t get_serialized_size_communication_interfaces_topic__msg__Depth(
  const void * untyped_ros_message,
...
static uint32_t _Depth__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication_interfaces_topic__msg__Depth(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_interfaces_topic
size_t max_serialized_size_communication_interfaces_topic__msg__Depth(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_communication_interfaces_topic__msg__Depth(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication_interfaces_topic, msg, Depth)() {
