...
static const _Thrust_type_support_symbol_names_t _Thrust_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_interfaces_topic, msg, Thrust)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication_interfaces_topic, msg, Thrust)),
  }
};
...
{
  return &::communication_interfaces_topic::msg::rosidl_typesupport_cpp::Thrust_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, communication_interfaces_topic, msg, Thrust)() {
  return get_message_type_support_handle<communication_interfaces_topic::msg::Thrust>();
}
