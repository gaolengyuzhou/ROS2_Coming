    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'communication_interfaces_topic.msg.Pose')
            logger.debug(
...
class Pose(metaclass=Metaclass_Pose):
    ...
    def __init__(self, **kwargs):
        ...
        self.pose_data = array.array('f', kwargs.get('pose_data', []))
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.pose_data != other.pose_data:
            return False
        return True
    ...
    def pose_data(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'pose_data' array.array() must have the type code of 'f'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'pose_data' field must be a set or sequence and each value of type 'float'"
        self._pose_data = array.array('f', value)
