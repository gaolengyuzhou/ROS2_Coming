...
#include <stddef.h>
#include "communication_interfaces_topic/msg/detail/pose__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  communication_interfaces_topic__msg__Pose__init(message_memory);
}

void Pose__rosidl_typesupport_introspection_c__Pose_fini_function(void * message_memory)
{
  communication_interfaces_topic__msg__Pose__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Pose__rosidl_typesupport_introspection_c__Pose_message_member_array[1] = {
  {
    ...
    offsetof(communication_interfaces_topic__msg__Pose, pose_data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Pose__rosidl_typesupport_introspection_c__Pose_message_members = {
  ...
  "Pose",  // message name
  1,  // number of fields
  sizeof(communication_interfaces_topic__msg__Pose),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, communication_interfaces_topic, msg, Pose)() {
