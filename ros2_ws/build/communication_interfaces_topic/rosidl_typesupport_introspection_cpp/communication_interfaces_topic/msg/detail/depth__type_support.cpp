...
{
  new (message_memory) communication_interfaces_topic::msg::Depth(_init);
}

void Depth_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication_interfaces_topic::msg::Depth *>(message_memory);
  typed_message->~Depth();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Depth_message_member_array[1] = {
  {
    "depth_data",  // name
    ...
    offsetof(communication_interfaces_topic::msg::Depth, depth_data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Depth_message_members = {
  ...
  "Depth",  // message name
  1,  // number of fields
  sizeof(communication_interfaces_topic::msg::Depth),
...
{
  return &::communication_interfaces_topic::msg::rosidl_typesupport_introspection_cpp::Depth_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication_interfaces_topic, msg, Depth)() {
  return &::communication_interfaces_topic::msg::rosidl_typesupport_introspection_cpp::Depth_message_type_support_handle;
}
