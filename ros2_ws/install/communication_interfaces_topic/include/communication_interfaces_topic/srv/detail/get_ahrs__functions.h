...
#ifndef COMMUNICATION_INTERFACES_TOPIC__SRV__DETAIL__GET_AHRS__FUNCTIONS_H_
#define COMMUNICATION_INTERFACES_TOPIC__SRV__DETAIL__GET_AHRS__FUNCTIONS_H_
...
/// Initialize srv/GetAHRS message.
/**
...
/// Create srv/GetAHRS message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * communication_interfaces_topic__srv__GetAHRS_Request__init().
...
/// Destroy srv/GetAHRS message.
/**
 * It calls
 * communication_interfaces_topic__srv__GetAHRS_Request__fini()
...
/// Check for srv/GetAHRS message equality.
/**
...
/// Initialize array of srv/GetAHRS messages.
/**
...
/// Finalize array of srv/GetAHRS messages.
/**
 * It calls
 * communication_interfaces_topic__srv__GetAHRS_Request__fini()
...
/// Create array of srv/GetAHRS messages.
/**
 * It allocates the memory for the array and calls
 * communication_interfaces_topic__srv__GetAHRS_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetAHRS messages.
/**
 * It calls
 * communication_interfaces_topic__srv__GetAHRS_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetAHRS message array equality.
/**
...
/// Copy an array of srv/GetAHRS messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * communication_interfaces_topic__srv__GetAHRS_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_interfaces_topic
...
/**
 * It calls
 * communication_interfaces_topic__srv__GetAHRS_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_interfaces_topic
...
/**
 * It allocates the memory for the array and calls
 * communication_interfaces_topic__srv__GetAHRS_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_interfaces_topic
...
/**
 * It calls
 * communication_interfaces_topic__srv__GetAHRS_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMUNICATION_INTERFACES_TOPIC__SRV__DETAIL__GET_AHRS__FUNCTIONS_H_
