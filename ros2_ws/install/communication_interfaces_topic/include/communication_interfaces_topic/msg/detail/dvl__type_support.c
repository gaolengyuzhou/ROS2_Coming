...
#include <stddef.h>
#include "communication_interfaces_topic/msg/detail/dvl__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  communication_interfaces_topic__msg__DVL__init(message_memory);
}

void DVL__rosidl_typesupport_introspection_c__DVL_fini_function(void * message_memory)
{
  communication_interfaces_topic__msg__DVL__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember DVL__rosidl_typesupport_introspection_c__DVL_message_member_array[1] = {
  {
    "dvl_data",  // name
    ...
    offsetof(communication_interfaces_topic__msg__DVL, dvl_data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers DVL__rosidl_typesupport_introspection_c__DVL_message_members = {
  ...
  "DVL",  // message name
  1,  // number of fields
  sizeof(communication_interfaces_topic__msg__DVL),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, communication_interfaces_topic, msg, DVL)() {
