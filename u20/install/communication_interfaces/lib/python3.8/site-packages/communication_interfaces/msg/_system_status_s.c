...
bool communication_interfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("communication_interfaces.msg._system_status.SystemStatus", full_classname_dest, 56) == 0);
  }
  communication_interfaces__msg__SystemStatus * ros_message = _ros_message;
  {  // stamp
...
PyObject * communication_interfaces__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("communication_interfaces.msg._system_status");
