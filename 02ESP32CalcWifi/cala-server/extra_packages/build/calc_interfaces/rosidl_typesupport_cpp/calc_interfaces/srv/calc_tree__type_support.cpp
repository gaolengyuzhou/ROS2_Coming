...
static const _CalcTree_Request_type_support_symbol_names_t _CalcTree_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, calc_interfaces, srv, CalcTree_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, calc_interfaces, srv, CalcTree_Request)),
  }
};
...
{
  return &::calc_interfaces::srv::rosidl_typesupport_cpp::CalcTree_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, calc_interfaces, srv, CalcTree_Request)() {
  return get_message_type_support_handle<calc_interfaces::srv::CalcTree_Request>();
}
...
static const _CalcTree_Response_type_support_symbol_names_t _CalcTree_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, calc_interfaces, srv, CalcTree_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, calc_interfaces, srv, CalcTree_Response)),
  }
};
...
{
  return &::calc_interfaces::srv::rosidl_typesupport_cpp::CalcTree_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, calc_interfaces, srv, CalcTree_Response)() {
  return get_message_type_support_handle<calc_interfaces::srv::CalcTree_Response>();
}
...
static const _CalcTree_type_support_symbol_names_t _CalcTree_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, calc_interfaces, srv, CalcTree)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, calc_interfaces, srv, CalcTree)),
  }
};
...
{
  return &::calc_interfaces::srv::rosidl_typesupport_cpp::CalcTree_service_type_support_handle;
}
