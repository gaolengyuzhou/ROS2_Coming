...
static const _Sermsg_Request_type_support_symbol_names_t _Sermsg_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces1, srv, Sermsg_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces1, srv, Sermsg_Request)),
  }
};
...
{
  return &::interfaces1::srv::rosidl_typesupport_cpp::Sermsg_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces1, srv, Sermsg_Request)() {
  return get_message_type_support_handle<interfaces1::srv::Sermsg_Request>();
}
...
static const _Sermsg_Response_type_support_symbol_names_t _Sermsg_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces1, srv, Sermsg_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces1, srv, Sermsg_Response)),
  }
};
...
{
  return &::interfaces1::srv::rosidl_typesupport_cpp::Sermsg_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces1, srv, Sermsg_Response)() {
  return get_message_type_support_handle<interfaces1::srv::Sermsg_Response>();
}
...
static const _Sermsg_type_support_symbol_names_t _Sermsg_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces1, srv, Sermsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces1, srv, Sermsg)),
  }
};
...
{
  return &::interfaces1::srv::rosidl_typesupport_cpp::Sermsg_service_type_support_handle;
}
